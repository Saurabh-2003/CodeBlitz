...
export const ContestRating = () => {
  ...
  const barSeries = [
    {
      name: "Percentage",
      data: [10, 20, 15, 25, 10, 5, 12, 18, 13, 15, 14, 18, 20, 17, 16, 12, 14, 15, 19, 21, 23, 20, 18] // Example data for 23 bars
    }
  ];

  return (
    <div className="w-full h-60 justify-between flex space-y-4 bg-white p-4">
